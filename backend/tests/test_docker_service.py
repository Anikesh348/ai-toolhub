...
def test_tool_runtime_environment_rewrites_local_compose_mongo_for_tool_containers() -> None:
    ...
    assert environment == {
        "MONGO_URI": "mongodb://toolhub:toolhub-dev-password@host.docker.internal:27018/ai-toolhub?authSource=admin",
        "MONGO_DB_NAME": "ai-toolhub",
        "MONGO_PORT": "27018",
        "TZ": "Asia/Kolkata",
    }
...
def test_build_service_environment_includes_shared_mongo_defaults() -> None:
    ...
    assert environment["MONGO_URI"] == (
        "mongodb://toolhub:toolhub-dev-password@host.docker.internal:27017/ai-toolhub?authSource=admin"
    )
...
def test_run_tool_container_passes_shared_mongo_environment_to_runtime() -> None:
    ...
    connect_mongo.assert_called_once_with(runtime_container)
